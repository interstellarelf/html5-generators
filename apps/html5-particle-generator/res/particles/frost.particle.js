...
module.exports = function(){
  ...
  var stats;
      ...
      image.src = './res/images/frost.png';
      ...
      var Controller = {
        ...
        ready: function(gameWindow){
            ...
            emitter.rate = new Proton.Rate(new Proton.Span(4, 6), .04);
            ...
            emitter.addInitialize(new Proton.V(new Proton.Span(2, 2), new Proton.Span(0, 30, true), 'polar'));
