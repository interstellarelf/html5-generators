...
var LightningSettings = {
  ...
  points: [new Gamelab.Vector(100, 100), new Gamelab.Vector(200, 100)],
  pcolor: '#444',
  pcolorShadow: '#FFF'
...
Point.prototype = (function(o) {
    ...
    update: function(points, bounds) {
        ...
        for (i = 0, len = points.length; i < len; i++) {
            ...
            p.x = LightningSettings.points[i].x;
            p.y = LightningSettings.points[i].y;
    ...
    draw: function(ctx) {
        ...
        ctx.fillStyle = LightningSettings.pcolor;
        ctx.beginPath();
        ctx.arc(this.x, this.y, this._currentRadius, 0, Math.PI * 2, false);
        ctx.fill();
        ctx.shadowBlur  = 20;
        ctx.shadowColor = LightningSettings.pcolorShadow;
...
Lightning.prototype = {
    ...
    lineWidth:     5,
    blur :         50,
    blurColor:     'rgba(200, 200, 240, 0.02)',
    points:        null,
    off:           0,
...
function LightningPointPair(gameWindow) {
  ...
  return (function() {
      ...
      lightning.loop = function() {
          ...
          requestAnimationFrame(lightning.loop);
      };
      ...
      lightning.startPoint.index = 0;
      lightning.endPoint.set(points[1]);

      lightning.endPoint.index = 1;
